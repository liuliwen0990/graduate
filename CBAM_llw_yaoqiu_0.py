...
class MLCNN(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(in_channels=3, out_channels=32, kernel_size=(3, 3), stride=2, padding=(1, 1), bias=False),
            nn.BatchNorm2d(32),
            nn.ReLU(),
        )
        ...
        self.conv2 = nn.Sequential(
            nn.Conv2d(in_channels=32, out_channels=64, kernel_size=(3, 3), stride=1, padding=0, bias=False),
            nn.BatchNorm2d(64),
            nn.ReLU(),
        )
        ...
        self.dropout2 = nn.Dropout(p=0.25)  # dropout训练

        self.conv3 = nn.Sequential(
            nn.Conv2d(in_channels=64, out_channels=64, kernel_size=(3, 3), stride=1, padding=(1,1), bias=False),
            nn.BatchNorm2d(64),
            nn.ReLU(),
        )
